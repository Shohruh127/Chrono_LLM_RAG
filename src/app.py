...
def chat_with_llm(message, history, hist_data, pred_data):
    ...
    if not llm_loaded:
        return history + [
            [message, "❌ Please load LLM first (click 'Load LLM' button)"]
        ]
    ...
    **Date: 2025-11-19 11:11:39 UTC**
    ...
    with gr.Tabs():
        ...
        with gr.Tab("📊 Forecast"):
            with gr.Row():
                with gr.Column():
                    ...
                    select_domain_btn = gr.Button(
                        "✅ Confirm Domain Selection", variant="primary", visible=False
                    )
        ...
        with gr.Tab("🤖 AI Analysis"):
            ...
            load_llm_btn = gr.Button(
                "🔄 Load LLM (First Time Only)", variant="secondary"
            )
            ...
            msg_input = gr.Textbox(
                ...
                placeholder="e.g., What happened with LOC_011_IND?",
            )
