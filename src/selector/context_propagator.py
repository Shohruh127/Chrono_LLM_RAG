...
class ContextPropagator:
    ...
    def get_domain_prompt(self) -> str:
        ...
        domain_focus = {
            "Agriculture": "agricultural metrics, crop yields, farming indicators, livestock production, and rural development",
            ...
            "Transport": "transportation metrics, logistics data, infrastructure utilization, and mobility patterns",
            "Construction": "construction output, building permits, real estate development, and infrastructure projects",
